...
<div id=userinfo>
<ul id=red>
<router-link :to="{name: 'Profil', params: {imekorisnika: korisnik.username}}"><li><img id="avatar" src="../assets/pplaceholder.jpg"/></li>
<li id="imekor">{{ korisnik.username }}</li></router-link>
</ul>
</div>
<div class="column">
<div id=userpodaci>
